...
public class PlayerMovement : MonoBehaviour
{
    ...
    //Moves the player using the inputed direction
    ...
    void OnDrawGizmos()
    {
        // Choose the color based on the grounded status
        Gizmos.color = grounded ? Color.green : Color.red;

        // Draw a line from the object downward to show the grounded check
        Gizmos.DrawLine(transform.position, transform.position + Vector3.down * (playerHeight * 0.5f + raycastOffset));
    }
